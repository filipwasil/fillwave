...
void init() {
	...
	lightSource_1->attach(make_unique<Model>(mEngine,
	                      program,
	                      "meshes/sphere.obj", "0_255_0.color"));
	lightSource_2->attach(make_unique<Model>(mEngine,
	                      program,
	                      "meshes/sphere.obj", "0_0_255.color"));
	lightSource_3->attach(make_unique<Model>(mEngine,
	                      program,
...
void perform() {
	...
	puModel wall = make_unique<Model>(mEngine, program,
	                                  "meshes/floor.obj");
