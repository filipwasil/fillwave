...
void perform() {
	...
	puIEmiterPoint water = make_unique<EmiterPointCPU>(mEngine,
	                       0.3,
	                       60000.0,
	...
	puIEmiterPoint sand = make_unique<EmiterPointCPU>(mEngine,
	                      0.3,
	                      60000.0,
	...
	puIEmiterPoint snow = make_unique<EmiterPointGPU>(mEngine,
	                      0.3,
	                      600.0,
...
void showDescription() {
	pText hint0 =
	   mEngine->storeText("Fillwave example particles",
	         "fonts/Titania",
