...
//                beast_animated2->scaleTo(0.1);
  ...
  pLightSpot l1 = engine->storeLightSpot(glm::vec3(0.0, 1.0, 0.0), glm::quat(), glm::vec4(1.0, 1.0, 1.0, 0.0), entity1);

  entity1->rotateByX(glm::radians(-90.0));

  entity1->moveBy(glm::vec3(0.0, 2.0, 0.0));

  entity1->attach(buildModel(engine, program, "sphere.obj", "255_255_255.color"));
