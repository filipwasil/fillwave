...
#include "../../../android/inc/ContextOpenSL/hello_clip.h"
;

static const char android[] =
#include "../../../android/inc/ContextOpenSL/android_clip.h"
;
...
jboolean createUriAudioPlayer(JNIEnv* env, jclass clazz,
        jstring uri)
{
    SLresult result;
...
void setPlayingUriAudioPlayer(/*JNIEnv* env,
...
void setLoopingUriAudioPlayer(JNIEnv* env,
...
void setChannelMuteUriAudioPlayer(JNIEnv* env,
...
void setChannelSoloUriAudioPlayer(JNIEnv* env,
...
void setVolumeUriAudioPlayer(JNIEnv* env, jclass clazz,
        jint millibel)
{
    SLresult result;
...
void setMuteUriAudioPlayer(JNIEnv* env, jclass clazz,
        jboolean mute)
{
    SLresult result;
    SLVolumeItf volumeItf = getVolume();
...
void enableStereoPositionUriAudioPlayer(JNIEnv* env,
...
void setStereoPositionUriAudioPlayer(JNIEnv* env,
...
jboolean enableReverb(JNIEnv* env, jclass clazz,
        jboolean enabled)
{
    SLresult result;
...
jboolean selectClip(/*JNIEnv* env, jclass clazz,*/ jint which,
        jint count)
{
    switch (which) {
    case 0:     // CLIP_NONE
...
jboolean createAssetAudioPlayer(JNIEnv* env, jclass clazz,
		AAssetManager* mgr, const char *utf8)
{
    SLresult result;
