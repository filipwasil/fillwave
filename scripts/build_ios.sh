...
# we are fine now. go.
cmake ../fillwave -G"Xcode" -DNDEBUG=OFF -DFILLWAVE_BUILD_PACK=ON -DFILLWAVE_BUILD_LIB=ON -DFILLWAVE_BUILD_DEV=OFF -DVERSION_MAJOR=1 -DVERSION_MINOR=0 -DVERSION_PATCH=0 -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS=OFF -DASSIMP_BUILD_TESTS=OFF -DASSIMP_BUILD_ASSIMP_TOOLS=OFF -DCMAKE_TOOLCHAIN_FILE=../fillwave/ext/ios-cmake/toolchain/iOS.cmake
