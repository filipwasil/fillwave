...
# Build library DEB
cmake ../fillwave -G"Eclipse CDT4 - Unix Makefiles" -DFILLWAVE_SUPPRESS_WARNINGS=OFF -DFILLWAVE_COMPILATION_STARTUP_ANIMATION=OFF -DFILLWAVE_COMPILATION_TINY_ASSET_LOADER=OFF -DNDEBUG=ON -DFILLWAVE_BUILD_PACK=ON -DFILLWAVE_BUILD_DEV=OFF -DVERSION_MAJOR=$1 -DVERSION_MINOR=$2 -DVERSION_PATCH=$3 -D_ECLIPSE_VERSION="4.4" && make -j8
