...
add_custom_target (
    copy_win
    COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_BINARY_DIR}/ext/glew/Debug/glew${GLEW_LIBRARY_NAME_BITS}d.lib ${CMAKE_CURRENT_BINARY_DIR}/Debug/
    COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_CURRENT_BINARY_DIR}/ext/glew/Debug/glew${GLEW_LIBRARY_NAME_BITS}d.dll ${CMAKE_CURRENT_BINARY_DIR}/Debug/
