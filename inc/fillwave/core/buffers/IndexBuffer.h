...
class IndexBuffer: public IBuffer {
 public:
	...
	IndexBuffer(GLuint elements, bool fill, GLuint dataStoreModification);
	IndexBuffer(const std::vector<GLuint>& data, GLuint dataStoreModification);
#ifdef FILLWAVE_MODEL_LOADER_ASSIMP
	IndexBuffer(const aiMesh* shape, GLuint dataStoreModification);
