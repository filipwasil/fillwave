...
:EmiterPoint(engine,
 ...
 mTimeDeltaEmiter(0.0) {
   ...
   mVBOGPU[0] = pVertexBufferParticlesGPU(new core::VertexBufferParticlesGPU(particles));//xxx todo store in engine
   mVBOGPU[1] = pVertexBufferParticlesGPU(new core::VertexBufferParticlesGPU(particles));//xxx todo store in engine
...
inline void EmiterPointGPU::initPipeline() {
   ...
   glTransformFeedbackVaryings (mProgramEmiter->getHandle(),
                                6,
