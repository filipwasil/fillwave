...
core::IndexBuffer* Engine::storeBufferInternal(core::VertexArray* vao, std::vector<GLuint>& data) {
   core::IndexBuffer* newData = new core::IndexBuffer(data);
	return mImpl->mBuffers.mIndices.store(vao, newData);
}
...
core::IndexBuffer* Engine::storeBufferInternal(core::VertexArray* vao, GLuint elements) {
   core::IndexBuffer* newData = new core::IndexBuffer(elements);
	return mImpl->mBuffers.mIndices.store(vao, newData);
}
