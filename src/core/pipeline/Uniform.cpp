...
void Uniform::push(GLint value) { glUniform1i(mLocation, value); FLOG_CHECK("Uniform push failed");}
void Uniform::push(GLint* value, GLint size) { glUniform1iv(mLocation, size, value); FLOG_CHECK("Uniform push failed");}
void Uniform::push(GLfloat value)   { glUniform1f(mLocation, value ); FLOG_CHECK("Uniform push failed");}
void Uniform::push(GLfloat* value, GLint size) { glUniform1fv(mLocation, size, value); FLOG_CHECK("Uniform push failed");}
void Uniform::push(glm::vec2 value) { glUniform2fv(mLocation, 1, glm::value_ptr(value) ); FLOG_CHECK("Uniform push failed");}
void Uniform::push(glm::vec3 value) { glUniform3fv(mLocation, 1, glm::value_ptr(value) ); FLOG_CHECK("Uniform push failed");}
void Uniform::push(glm::vec4 value) { glUniform4fv(mLocation, 1, glm::value_ptr(value) ); FLOG_CHECK("Uniform push failed");}
void Uniform::push(glm::mat2 value) { glUniformMatrix2fv(mLocation, 1, GL_FALSE, glm::value_ptr(value) ); FLOG_CHECK("Uniform push failed");}
void Uniform::push(glm::mat3 value) { glUniformMatrix3fv(mLocation, 1, GL_FALSE, glm::value_ptr(value) ); FLOG_CHECK("Uniform push failed");}
void Uniform::push(glm::mat4 value) { glUniformMatrix4fv(mLocation, 1, GL_FALSE, glm::value_ptr( value )); FLOG_CHECK("Uniform push failed");}
void Uniform::push(glm::vec3* value, GLuint size) { glUniform3fv(mLocation, size, (GLfloat*) value ); FLOG_CHECK("Uniform push failed");}
void Uniform::push(glm::mat4* value, GLuint size) { glUniformMatrix4fv(mLocation, size, GL_FALSE, (GLfloat*)value ); FLOG_CHECK("Uniform push failed");}
