...
Texture3D::Texture3D(Texture2DFile *fileRight,
    ...
    : Texture (GL_TEXTURE_CUBE_MAP), mRight (std::make_unique<Texture3DFile> (fileRight,
                                                                              GL_TEXTURE_CUBE_MAP_POSITIVE_X)), mLeft (
    std::make_unique<Texture3DFile> (fileLeft, GL_TEXTURE_CUBE_MAP_NEGATIVE_X))
