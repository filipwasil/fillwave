...
Texture3D::Texture3D(
		...
		:
				...
				mRight(
						puTexture3DFile(
								new Texture3DFile(fileRight,
										GL_TEXTURE_CUBE_MAP_POSITIVE_X))),
				mLeft(
						puTexture3DFile(
								new Texture3DFile(fileLeft,
										GL_TEXTURE_CUBE_MAP_NEGATIVE_X))),
				mCeil(
						puTexture3DFile(
								new Texture3DFile(fileCeil,
										GL_TEXTURE_CUBE_MAP_POSITIVE_Y))),
				mFloor(
						puTexture3DFile(
								new Texture3DFile(fileFloor,
										GL_TEXTURE_CUBE_MAP_NEGATIVE_Y))),
				mFront(
						puTexture3DFile(
								new Texture3DFile(fileFront,
										GL_TEXTURE_CUBE_MAP_POSITIVE_Z))),
				mBack(
						puTexture3DFile(
								new Texture3DFile(fileBack,
